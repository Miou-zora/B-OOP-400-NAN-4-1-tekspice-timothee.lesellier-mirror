...
Test(Component4011, InvalidSetlink)
{
    ...
    try {
        Component4011.setLink(7, input1, 1);
...
Test(Component4011, invalid_pin)
{
    nts::Component4011 Component4011;

    try {
        Component4011.compute(1);
        cr_assert_fail("Should have thrown an exception");
    } catch (const std::invalid_argument &e) {
        cr_assert_str_eq(e.what(), "Pin out of range");
    }
    try {
        Component4011.compute(7);
        cr_assert_fail("Should have thrown an exception");
    } catch (const std::invalid_argument &e) {
        cr_assert_str_eq(e.what(), "Pin out of range");
    }
    try {
        Component4011.compute(14);
        cr_assert_fail("Should have thrown an exception");
    } catch (const std::invalid_argument &e) {
        cr_assert_str_eq(e.what(), "Pin out of range");
    }
...
Test(Component4011, casual_undefined)
{
    nts::Component4011 Component4011;
    std::shared_ptr<nts::Input> input1 = std::make_shared<nts::Input>();
    std::shared_ptr<nts::Input> input2 = std::make_shared<nts::Input>();
    ...
    for (auto &pin: outputs) {
        ...
        cr_assert_eq(Component4011.compute(pin), nts::Tristate::Undefined);
        Component4011.setLink(inputs.at(pin).at(0), input1, 1);
        Component4011.setLink(inputs.at(pin).at(1), input2, 1);
...
Test(Component4011, casual_true)
{
    nts::Component4011 Component4011;
    std::shared_ptr<nts::Input> input1 = std::make_shared<nts::Input>();
    std::shared_ptr<nts::Input> input2 = std::make_shared<nts::Input>();
    ...
    for (auto &pin: outputs) {
        ...
        input2->setCurrentState(nts::Tristate::True);
        input1->setCurrentState(nts::Tristate::True);
        cr_assert_eq(Component4011.compute(pin), nts::Tristate::False);
    }
}

Test(Component4011, no_links)
{
    nts::Component4011 Component4011;
    std::vector<std::size_t> outputs = {3, 4, 10, 11};
...
Test(Component4011, casual_false)
{
    nts::Component4011 Component4011;
    std::shared_ptr<nts::Input> input1 = std::make_shared<nts::Input>();
    std::shared_ptr<nts::Input> input2 = std::make_shared<nts::Input>();
    ...
    for (auto &pin: outputs) {
        ...
        cr_assert_eq(Component4011.compute(pin), nts::Tristate::True);
        input2->setCurrentState(nts::Tristate::False);
